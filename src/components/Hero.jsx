...
function Hero() {
  ...
  return (
    <div className="w-full p-0 m-0 flex flex-col ">
      ...
      <div className="absolute z-10 text-2xl flex gap-8 text-slate-100 bg-black/30 top-9 right-12 backdrop-blur-2xl rounded-2xl p-4">
        {headings.map((ele) => (
          <h1
      ...
      {/* Centered Content */}
      <div className="absolute top-1/2 left-12  z-10 transform  -translate-y-1/2 text-center text-white">
        ...
        <Button
          ...
          sx={{
            ...
            fontSize: "1.1rem",
            "&:hover": {
              backgroundColor: "white", // Example: Darker shade of primary color
              color: "black", // Example: Change text color to black
              transform: "scale(1.1)",
